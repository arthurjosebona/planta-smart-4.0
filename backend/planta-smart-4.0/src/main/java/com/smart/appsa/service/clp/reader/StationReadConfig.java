...
public record StationReadConfig(Estacao estacao, long delayMs, List<PlcReadRequest> reads) {
    ...
    public static Map<Estacao, StationReadConfig> padroes() {
        return Map.of(
                Estacao.ESTOQUE, new StationReadConfig(Estacao.ESTOQUE, 600, List.of(
                        new PlcReadRequest(9, 0, 111),
                        new PlcReadRequest(6, 0, 60))),
                Estacao.PROCESSO, new StationReadConfig(Estacao.PROCESSO, 400, List.of(
                        new PlcReadRequest(2, 0, 9))),
                Estacao.MONTAGEM, new StationReadConfig(Estacao.MONTAGEM, 400, List.of(
                ...
                Estacao.EXPEDICAO, new StationReadConfig(Estacao.EXPEDICAO, 600, List.of(
