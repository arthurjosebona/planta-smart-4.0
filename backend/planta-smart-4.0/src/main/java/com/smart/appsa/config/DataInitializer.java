...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (estoqueRepository.count() == 0) {
            ...
            Estoque.builder().posicaoFisica(1).corEstoque(CorEstoque.VAZIO).build(),
            Estoque.builder().posicaoFisica(2).corEstoque(CorEstoque.VAZIO).build(),
            Estoque.builder().posicaoFisica(3).corEstoque(CorEstoque.VAZIO).build(),
            Estoque.builder().posicaoFisica(4).corEstoque(CorEstoque.VAZIO).build(),
            Estoque.builder().posicaoFisica(5).corEstoque(CorEstoque.VAZIO).build(),
            Estoque.builder().posicaoFisica(6).corEstoque(CorEstoque.VAZIO).build(),
            Estoque.builder().posicaoFisica(7).corEstoque(CorEstoque.VAZIO).build(),
        ...
        if (expedicaoRepository.count() == 0) {
            ...
            expedicaoRepository.saveAll(List.of(
                Expedicao.builder().ordemDeProducaoAtual(0).posicaoFisica(1).build(),
                Expedicao.builder().ordemDeProducaoAtual(0).posicaoFisica(2).build(),
                Expedicao.builder().ordemDeProducaoAtual(0).posicaoFisica(3).build(),
